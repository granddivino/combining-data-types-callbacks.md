...
const vendingMachine = {
    Snacks: [
        ...
        {Name:'Gushers', Price: 1}
    ],
    Vend: (number) => {
        return vendingMachine.Snacks[number].Name;
    }
}

console.log(vendingMachine.Vend(2)) //Gushers
// ## Callbacks
...
// 5. Make a function `calculate` that takes three arguments. Assume the two arguments are a number  
...
//There is no = sign between "foo" in the const declaration to declare that foo "is equivalent to this function"
// And the function can't be called before the function declaration
